...
public class C08_MultipleCheckedExceptions {
    ...
    public static void main(String[] args) {
        ...
        String dosyaYolu = "src/day31_exceptions/notlar.txt";// notlar-->sağ tuş+copy path/reference-->src/... olan seçilir.
        ...
        } catch (IOException e) { // IO ==> Input Output // bu metot olmasaydı, read'in altı kırmızı yanardı
                                                         // read'in üstüne gelip, add catch clause dedik.
