...
public class C01_DataCasting {
    ...
    public static void main(String[] args) {
        ...
        1-String ve boolean başka data türünden deger kabul etmez.

        2-Char özel olarak incelenecek ama String,boolean,float ve double değerler kabul etmez.

        3-Sayısal data türlerine gelince;
          dar kapsamli degeri, geniş kapsamlı variable'a atamak istersek, java bu işlemi otomatik olarak yapar.
...
//         chr = shrt;
        ...
        //kendinden büyük değerlere atanamayacaktır. Bu yüzden sadece kendinden küçük değerlere atanabilir.
/*
        byt = shrt; // 23
        byt = sayiInt; // 30
        byt = lng; // 40
