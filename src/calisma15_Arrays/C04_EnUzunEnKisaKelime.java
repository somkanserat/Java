...
public class C04_EnUzunEnKisaKelime {
    ...
    public static void main(String[] args) {
        ...
        //Verilen String bir array’deki en uzun ve en kisa kelimeleri yazdirın

        String[] isimler = {"hamza", "esra","can", "serat", "ali", "cansu","ibrahim","yasemin"};
        ...
        System.out.println("Eşit uzunlukta olanlar göz ardı edilmiştir.");
    ...
    public static void enKisaVeEnUzunYazdir(String arr[]){
