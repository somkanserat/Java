...
public class P01_stringBuilder {
    public static void main(String[] args) {
        ...
        System.out.println("sb4 =" + sb4); // Java öğrenen pişman olmaz.
        System.out.println("sb4 ün uzunluğu =" + sb4.length()); // 26
        System.out.println("sb4 ün kapasitesi =" + sb4.capacity()); // 42
