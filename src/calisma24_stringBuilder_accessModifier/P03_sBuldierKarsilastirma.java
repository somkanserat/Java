...
public class P03_sBuldierKarsilastirma {
    ...
    public static void main(String[] args) {
        ...
        //Aynı metne (içeriğe) sahip str1, sb1, sb2 yi karşılaştıralım
        System.out.println("----------------------------------");
        ...
        // karşılaştırmaya başlarken ilk farklı karakterde durur ve karakterler arası
        // farkı ASCII değeriyle bildirir
