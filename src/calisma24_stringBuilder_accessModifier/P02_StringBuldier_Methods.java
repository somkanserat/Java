package calisma24_stringBuilder_accessModifier;
...
public class P02_StringBuldier_Methods {
    ...
    public static void main(String[] args) {
        ...
        // sb1 tersten yazılarak ataandığı için eski haline dönmek istersek tekrar reverse()
        // methodu kullanılmalıdır
        sb1.reverse();
        //tersinin tersi kendisidir!
        System.out.println(sb1);  //Nice have a day

        // İsim aynı olsa bile String ve StrinBuilder da uygulama farklı olabilir

        //replace metodu index alarak istenen aralıktaki metni silip yerine
        //istediğiniz bir metni koyar
        ...
        //Verilen indexten itibaren ilgili str değeri variable a eklenir
